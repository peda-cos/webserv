...
enum HttpStatusCode {
    ...
    HTTP_VERSION_NOT_SUPPORTED = 505, GATEWAY_TIMEOUT = 504
};
...
enum ConfigDirectiveType { 
    ...
    SERVER_LISTEN, SERVER_LOCATION, SERVER_ROOT, SERVER_NAMES, SERVER_CLIENT_MAX_BODY_SIZE, SERVER_ERROR_PAGE, SERVER_INDEX,
