...
- Viola diretamente a regra do Projeto: *"seu programa não deve travar sob nenhuma circunstância"*.
...
## errno — A Variável que o Projeto Proíbe Verificar
...
### Por que o Projeto Proíbe Verificar errno Após read/write
